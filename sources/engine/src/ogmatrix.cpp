...
bool MatrixInverseEx2(OGMatrix& mOut, const OGMatrix& mIn)
{
	...
	MAT(mOut.f, 0, 0) = r0[4]; MAT(mOut.f, 0, 1) = r0[5]; MAT(mOut.f, 0, 2) = r0[6]; MAT(mOut.f, 0, 3) = r0[7]; 
    MAT(mOut.f, 1, 0) = r1[4]; MAT(mOut.f, 1, 1) = r1[5]; MAT(mOut.f, 1, 2) = r1[6]; MAT(mOut.f, 1, 3) = r1[7]; 
    MAT(mOut.f, 2, 0) = r2[4]; MAT(mOut.f, 2, 1) = r2[5]; MAT(mOut.f, 2, 2) = r2[6]; MAT(mOut.f, 2, 3) = r2[7]; 
    MAT(mOut.f, 3, 0) = r3[4]; MAT(mOut.f, 3, 1) = r3[5]; MAT(mOut.f, 3, 2) = r3[6]; MAT(mOut.f, 3, 3) = r3[7];
